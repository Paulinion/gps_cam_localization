Позволяет продолжать получать GPS координаты, даже если GPS не доступен, благодаря стерео камере, так же наносит маршрут и текущее положение на карту в реальном времению.
